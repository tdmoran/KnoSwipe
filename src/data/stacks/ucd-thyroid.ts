...
export const cards: CardData[] = [
...

  {
    ...
    options: [
      { label: 'A', text: 'Superior thyroid artery (from external carotid)' },
      { label: 'B', text: 'Inferior thyroid artery (from thyrocervical trunk)' },
      { label: 'C', text: 'Internal carotid artery' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Follicular cells; opposes insulin' },
      { label: 'B', text: 'Parafollicular (C) cells; opposes cortisol' },
      { label: 'C', text: 'Oxyphil cells; opposes parathyroid hormone' },
      { label: 'D', text: 'Parafollicular (C) cells; opposes parathyroid hormone' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Posterior pituitary; positive feedback by T3/T4' },
      { label: 'B', text: 'Anterior pituitary; negative feedback by circulating T3/T4' },
...

  {
    ...
    options: [
      { label: 'A', text: "Trousseau's sign — carpal spasm with blood pressure cuff" },
      { label: 'B', text: "Chvostek's sign — facial twitch on tapping" },
      { label: 'C', text: "Pemberton's sign — arms raised above head causing facial congestion" },
...

  {
    ...
    options: [
      { label: 'A', text: 'Suspicion of malignancy' },
      { label: 'B', text: 'Elevated TSH alone without structural abnormality' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Pure cyst, anechoic with posterior enhancement' },
      { label: 'B', text: 'Homogeneous, hyperechoic, solid with halo' },
      { label: 'C', text: 'Spongiform appearance with multiple small cysts' },
      { label: 'D', text: 'Solid, hypoechoic, lobulated/irregular outline, microcalcification' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      ...
      { label: 'C', text: 'All categories had equal malignancy rates' },
      { label: 'D', text: 'TR4 — approximately 22% confirmed malignancy' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: '14 gauge core biopsy needle' },
      { label: 'B', text: '23-25 gauge fine needle' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Psammoma bodies alone' },
      { label: 'B', text: 'Amyloid deposits with Congo red staining' },
      { label: 'C', text: 'Giant multinucleated cells' },
      { label: 'D', text: '"Orphan Annie eye" nuclei — clear, ground-glass, overlapping' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Haematogenous spread to lungs and bone' },
      { label: 'B', text: 'Perineural invasion along the recurrent laryngeal nerve' },
      { label: 'C', text: 'Lymphatic spread to cervical lymph nodes' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Thyroglobulin; 50% are familial' },
      { label: 'B', text: 'AFP; 10% are familial' },
      { label: 'C', text: 'CA-125; all are sporadic' },
      { label: 'D', text: 'Calcitonin and CEA; 20-25% are familial (MEN 2)' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: "Graves' disease; total thyroidectomy" },
      { label: 'B', text: "Hashimoto's thyroiditis; chemotherapy +/- radiation (not surgery)" },
...

  {
    ...
    options: [
      { label: 'A', text: 'Subtotal thyroidectomy only' },
      { label: 'B', text: 'Lobectomy with isthmusectomy' },
      { label: 'C', text: 'Total thyroidectomy with shave excision/window resection of trachea' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Complete aphonia and stridor requiring tracheostomy' },
      { label: 'B', text: 'Dysphagia without voice change' },
      { label: 'C', text: 'High-pitched voice with normal volume' },
      { label: 'D', text: 'Hoarse, breathy voice with intact airway' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Voice loss only; speech therapy' },
      { label: 'B', text: 'Aspiration pneumonia; antibiotics' },
      { label: 'C', text: 'Airway obstruction from bilateral vocal cord adduction; reintubation or tracheostomy' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Recurrent laryngeal nerve palsy' },
      { label: 'B', text: 'Hypocalcaemia due to hypoparathyroidism' },
...

  {
    ...
    options: [
      { label: 'A', text: 'IV dexamethasone and observe' },
      { label: 'B', text: 'Urgent CT neck' },
      { label: 'C', text: 'Open the wound at the bedside to evacuate haematoma, then return to theatre' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Four-gland hyperplasia (85%)' },
      { label: 'B', text: 'Solitary parathyroid adenoma (85%)' },
...

  {
    ...
    options: [
      { label: 'A', text: '"Lump, bump, dump, and pump"' },
      { label: 'B', text: '"Tall, thin, tremor, tachycardia"' },
      { label: 'C', text: '"Weight loss, weakness, wasting, warmth"' },
      { label: 'D', text: '"Bones, stones, abdominal moans, and psychic groans"' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Angle of mandible — nerve runs along the periosteum' },
      { label: 'B', text: 'Tragal pointer — nerve lies 1cm deep and inferior to the tragal cartilage' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Temporal branch' },
      { label: 'B', text: 'Buccal branch' },
      { label: 'C', text: 'Marginal mandibular branch' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Enucleation of the tumour only' },
      { label: 'B', text: 'Radical parotidectomy with facial nerve sacrifice' },
      { label: 'C', text: 'Radiotherapy alone' },
      { label: 'D', text: 'Superficial parotidectomy with facial nerve preservation' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Warthin tumour (papillary cystadenoma)' },
      { label: 'B', text: 'Acute parotitis' },
      { label: 'C', text: 'Basal cell adenoma' },
      { label: 'D', text: 'Carcinoma ex pleomorphic adenoma (malignant transformation)' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Rapid growth with early lymph node metastases; excellent prognosis' },
      { label: 'B', text: 'Benign behaviour with no recurrence after excision' },
      { label: 'C', text: 'Perineural invasion with pain; late lung metastases (10-year tumour); extent always greater than apparent' },
...

  {
    ...
    options: [
      ...
      { label: 'B', text: 'Mucoepidermoid carcinoma' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Facial nerve injury causing hemifacial spasm' },
      { label: 'B', text: 'Aberrant regeneration of parasympathetic auriculotemporal nerve fibres causing gustatory sweating' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Digastric muscle' },
      { label: 'B', text: 'Geniohyoid muscle' },
      { label: 'C', text: 'Masseter muscle' },
      { label: 'D', text: 'Mylohyoid muscle' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Sublingual gland duct openings' },
      { label: 'B', text: 'Minor salivary gland openings' },
      { label: 'C', text: "Wharton's duct papillae (submandibular duct openings)" },
...

  {
    ...
    options: [
      { label: 'A', text: 'Hypoglossal nerve' },
      { label: 'B', text: 'Inferior alveolar nerve' },
      { label: 'C', text: 'Glossopharyngeal nerve' },
      { label: 'D', text: 'Lingual nerve' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: 'Facial main trunk (CN VII), glossopharyngeal (CN IX), and vagus (CN X)' },
      { label: 'B', text: 'Inferior alveolar (CN V3), spinal accessory (CN XI), and phrenic (C3-5)' },
      { label: 'C', text: 'Marginal mandibular (CN VII), lingual (CN V3), and hypoglossal (CN XII)' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Tongue deviates away from the affected side' },
      { label: 'B', text: 'Loss of taste on the anterior two-thirds of the tongue' },
      { label: 'C', text: 'Loss of sensation on the posterior third of the tongue' },
      { label: 'D', text: 'Tongue deviates towards the affected side on protrusion' },
    ],
    correctIndex: 3,
...

  {
    ...
    options: [
      { label: 'A', text: '80% in submandibular, 80% are malignant, 80% metastasise' },
      { label: 'B', text: '80% are bilateral, 80% recur, 80% need radiation' },
      { label: 'C', text: '80% in parotid, 80% of parotid tumours are benign, 80% of benign parotid tumours are pleomorphic adenomas' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Most common in the submandibular gland; rapidly progressive; affects children' },
      { label: 'B', text: 'Almost exclusively in the parotid; more common in women; rare, slow-growing, sometimes cystic' },
...

  {
    ...
    options: [
      { label: 'A', text: 'Floor of mouth beside the frenulum of the tongue' },
      { label: 'B', text: 'Hard palate near the incisive papilla' },
      { label: 'C', text: 'Soft palate beside the tonsil' },
      { label: 'D', text: 'Buccal mucosa opposite the upper second molar tooth' },
    ],
    correctIndex: 3,
