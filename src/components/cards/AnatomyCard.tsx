...
import { type AnatomyCardData, categoryColors, difficultyColors } from '@/data/types';
import styles from './AnatomyCard.module.css';
...
function LarynxSVG() {
  return (
    <svg viewBox="0 0 200 320" fill="none" className={styles.svg}>
      <defs>
...
function SinusesSVG() {
  return (
    <svg viewBox="0 0 200 280" fill="none" className={styles.svg}>
      <defs>
...
function NeckTrianglesSVG() {
  return (
    <svg viewBox="0 0 240 340" fill="none" className={styles.svg}>
      <defs>
      ...
      <path d="M50,40 Q70,20 120,15 Q170,20 190,40 L180,70 Q160,85 120,90 Q80,85 60,70 Z" stroke="rgba(255,92,114,0.5)" strokeWidth="2" fill="rgba(255,92,114,0.04)" />
      <path d="M20,300 Q60,285 120,290 Q180,285 220,300" stroke="rgba(255,92,114,0.5)" strokeWidth="2" fill="none" />
      <path d="M60,70 Q45,130 40,200 Q35,260 20,300" stroke="rgba(255,92,114,0.2)" strokeWidth="1" fill="none" />
      <path d="M180,70 Q195,130 200,200 Q205,260 220,300" stroke="rgba(255,92,114,0.2)" strokeWidth="1" fill="none" />
      <path d="M75,55 Q65,120 55,200 Q45,260 30,295" stroke="rgba(255,92,114,0.7)" strokeWidth="3" fill="none" />
      <path d="M165,55 Q175,120 185,200 Q195,260 210,295" stroke="rgba(255,92,114,0.7)" strokeWidth="3" fill="none" />
      ...
      <path d="M95,90 Q105,110 120,105 Q135,110 145,90" stroke="rgba(255,92,114,0.35)" strokeWidth="1.5" fill="none" strokeDasharray="3,3" />
      <path d="M110,165 Q130,175 170,200 Q195,215 210,235" stroke="rgba(255,92,114,0.3)" strokeWidth="1.5" fill="none" strokeDasharray="3,3" />
      <path d="M130,165 Q110,175 70,200 Q45,215 30,235" stroke="rgba(255,92,114,0.3)" strokeWidth="1.5" fill="none" strokeDasharray="3,3" />
      <path d="M75,55 Q65,120 55,200 Q45,260 30,295 L120,290 L120,90 Q95,85 75,55" fill="rgba(255,92,114,0.03)" stroke="none" />
      <path d="M165,55 Q175,120 185,200 Q195,260 210,295 L220,300 Q200,200 195,130 Q190,80 180,55" fill="rgba(77,142,255,0.03)" stroke="none" />
...
function NeckFascialSVG() {
  return (
    <svg viewBox="0 0 280 280" fill="none" className={styles.svg}>
      <defs>
      ...
      <ellipse cx="140" cy="140" rx="128" ry="120" stroke="rgba(255,92,114,0.3)" strokeWidth="1.5" fill="rgba(255,92,114,0.02)" />
      <ellipse cx="140" cy="140" rx="115" ry="108" stroke="rgba(255,92,114,0.5)" strokeWidth="2" fill="rgba(255,92,114,0.04)" />
      <ellipse cx="58" cy="135" rx="18" ry="28" stroke="rgba(255,92,114,0.6)" strokeWidth="1.5" fill="rgba(255,92,114,0.08)" transform="rotate(-15 58 135)" />
      <ellipse cx="222" cy="135" rx="18" ry="28" stroke="rgba(255,92,114,0.6)" strokeWidth="1.5" fill="rgba(255,92,114,0.08)" transform="rotate(15 222 135)" />
      <ellipse cx="140" cy="128" rx="48" ry="44" stroke="rgba(77,142,255,0.5)" strokeWidth="2" fill="rgba(77,142,255,0.04)" strokeDasharray="5,3" />
      <circle cx="140" cy="115" r="22" stroke="rgba(0,229,160,0.5)" strokeWidth="2" fill="rgba(0,229,160,0.06)" />
      <circle cx="140" cy="115" r="14" stroke="rgba(0,229,160,0.3)" strokeWidth="1" fill="rgba(0,229,160,0.02)" />
      <ellipse cx="140" cy="152" rx="14" ry="10" stroke="rgba(167,139,250,0.5)" strokeWidth="1.5" fill="rgba(167,139,250,0.06)" />
      <ellipse cx="85" cy="130" rx="16" ry="18" stroke="rgba(255,92,114,0.6)" strokeWidth="2" fill="rgba(255,92,114,0.06)" />
      ...
      <ellipse cx="195" cy="130" rx="16" ry="18" stroke="rgba(255,92,114,0.6)" strokeWidth="2" fill="rgba(255,92,114,0.06)" />
      ...
      <path d="M70,185 Q140,175 210,185 L210,220 Q140,230 70,220 Z" stroke="rgba(167,139,250,0.5)" strokeWidth="2" fill="rgba(167,139,250,0.04)" />
      <rect x="118" y="190" width="44" height="30" rx="6" stroke="rgba(255,92,114,0.4)" strokeWidth="2" fill="rgba(255,92,114,0.06)" />
      <circle cx="140" cy="205" r="8" stroke="rgba(255,92,114,0.3)" strokeWidth="1" fill="rgba(255,92,114,0.03)" />
